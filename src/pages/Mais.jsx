...
import { Shield, Users, Settings, ChevronRight, AlertTriangle, CheckCircle, RefreshCw } from 'lucide-react'
  ...
  return (
    <div>
      <div style={{ marginBottom: 20 }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--t3)', margin: 0 }}>KYC, compliance e configurações</p>
      </div>
